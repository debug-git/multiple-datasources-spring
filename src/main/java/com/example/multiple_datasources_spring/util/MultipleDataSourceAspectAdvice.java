...
//    @Around("execution(* com.example.multiple_datasources_spring.*.*(..))")
//    public Object doAround(ProceedingJoinPoint jp) throws Throwable {
//        if (jp.getTarget() instanceof TestMapper) {
//            MultipleDataSource.setDataSourceKey("testDataSource");
//        } else if (jp.getTarget() instanceof DemoMapper) {
...
//    }
     ...
     */
    @Pointcut("execution(* com.example.multiple_datasources_spring.service..*.*(..))")
    public void aspect() {
    }
